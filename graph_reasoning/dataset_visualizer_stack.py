...
view1 = dataset_generator.base_graphs_views[0].filter_graph_by_node_attributes_containted({"view" : 1})
view2 = dataset_generator.base_graphs_views[0].filter_graph_by_node_attributes_containted({"view" : 2})
view3 = dataset_generator.base_graphs_views[0].filter_graph_by_node_attributes_containted({"view" : 3})
# visualize_nxgraph(dataset_generator.base_graphs_original[0], "original")
# visualize_nxgraph(dataset_generator.base_graphs_noise[0], "noise")
