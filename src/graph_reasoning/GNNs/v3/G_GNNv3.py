...
from graph_reasoning.GNNs.v3.EdgeAwareGatConv import GNNEncoder
from graph_reasoning.GNNs.v3.EdgeDecoderMulticlass import EdgeDecoderMulticlass

class G_GNNv3(torch.nn.Module):
